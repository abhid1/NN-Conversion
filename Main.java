...
public class Main {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // Handle an info context and a roman numeral context.
    ...
    static class ProjectInfoHandler implements HttpHandler
    {
        public void handle(HttpExchange httpExchange) throws IOException
        {
            ...
            String response = "<!DOCTYPE html>" +
                    ...
                    "<ul>" +
                    "<li> /info - gives information about the project </li>" +
                    "<li> /romannumeral?query=YOUR INTEGER - converts YOUR INTEGER (1-3999) to a roman numeral. </li>" +
                    "</ul>" +
    ...
    static class RomanNumeralHandler implements HttpHandler
    {
        public void handle(HttpExchange httpExchange) throws IOException
        {
            // Obtain conversion from Converter class
    ...
    /**
     * This method is responsible for outputting the given response (good response) from the server.
     * @param httpExchange
     * @param response
     * @throws IOException
     */
    ...
    /**
     * This method is responsible for outputting the given response (bad response) from the server.
     * @param httpExchange
     * @param response
     * @throws IOException
     */
